...
public class BufferMgr {
   ...
   /** Usage:
    * Buffer: Buffer Id [FileName Block Number] Pinned or Unpinned
    */
   public void printStatus() {
      System.out.println("Allocated Buffers:");
      if (bufferMgr.getAllocatedBuffersMap().size() > 0) {
         for(Map.Entry<Block, Buffer> entry : bufferMgr.getAllocatedBuffersMap().entrySet())
      ...
      for(Buffer buffer : bufferMgr.getUnpinnedBufferQueue())
