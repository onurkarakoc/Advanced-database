...
public class Transaction {
   ...
   private static int CKPT_PERIOD = 5;
   private static ArrayList<Integer> actTransList = new ArrayList<>();
   ...
   public Transaction() {
      ...
      if (!actTransList.isEmpty()&&txnum % CKPT_PERIOD == 0)
          recoveryMgr.checkpoint(actTransList);
      actTransList.add(txnum);
   ...
   public void commit() {
      ...
      concurMgr.release();
      myBuffers.unpinAll();
      actTransList.remove(new Integer(txnum));
